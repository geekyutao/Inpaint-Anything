...
def main_worker():
    ...
    net = importlib.import_module('STTN.model.' + args.model)
...
if __name__ == '__main__':
    '''
    1. Download STTN pretrained model and move it to ./STTN/checjpoints/sttn.pth
    2. Run:
        python sttn_video_inpaint.py \
            --video ./example/remove-anything-video/breakdance-flare/original_video.mp4 \
            --mask ./example/remove-anything-video/breakdance-flare/mask \
            --ckpt STTN/checkpoints/sttn.pth \
            --model sttn
    '''
    main_worker()
