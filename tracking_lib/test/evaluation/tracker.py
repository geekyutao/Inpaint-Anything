...
from tracking_lib.test.evaluation.environment import env_settings
import time
import cv2 as cv

from tracking_lib.utils.lmdb_utils import decode_img
...
class Tracker:
    ...
    def __init__(self, name: str, parameter_name: str, dataset_name: str, run_id: int = None, display_name: str = None,
        ...
        if os.path.isfile(tracker_module_abspath):
            tracker_module = importlib.import_module('tracking_lib.test.tracker.{}'.format(self.name))
    ...
    def get_parameters(self):
        """Get parameters."""
        param_module = importlib.import_module('tracking_lib.test.parameter.{}'.format(self.name))
