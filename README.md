...
## 📜 News
[2023/4/24] [Local web UI](./app/README.md) supported! You can run the demo website locally!\
...
- [x] [Local web UI](./app/README.md) supported (<span style="color:red">🔥NEW</span>)
