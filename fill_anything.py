...
from stable_diffusion_inpaint import fill_img_with_sd, DEFAULT_SD_INPAINT_MODEL
...
def setup_args(parser):
    ...
    parser.add_argument(
        ...
        help="Text prompt describing what to fill the hole with",
    )
    parser.add_argument(
        "--text_select", type=str, default=None,
        help="SAM 3 only: pick the target with a noun phrase (e.g. 'the dog') "
             "instead of a point. All matching instances are filled together.",
    )
    parser.add_argument(
